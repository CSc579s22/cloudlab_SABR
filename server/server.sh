...
sudo su; cd /var/www/html; wget -r --no-parent --reject \"index.html*\" http://ftp.itec.aau.at/datasets/DASHDataset2014/BigBuckBunny/2sec/
sudo cp /local/repository/server/BigBuckBunny_2s_mod* /var/www/html/ftp.itec.aau.at/datasets/DASHDataset2014/BigBuckBunny/2sec/
